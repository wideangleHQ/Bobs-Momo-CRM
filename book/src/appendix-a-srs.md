# Appendix A: the source SRS

This is the signed Software Requirements Specification, version 1.0, dated 16 August
2026, reproduced without edit. It is the contractual scope. Where this handbook and the
SRS disagree on a detail, the SRS wins on scope and this handbook wins on implementation.

Known defects in this document are catalogued in
[Phase 1 scope boundary](03-phase-1-scope.md) and worked through in
[Customer CRM and the game layer](32-customer-crm-and-game.md). In short: Section 6.3 is
missing, Section 15.7 and FR-CRM-001 are cited but do not exist, the TO-BE section
promises five pillars and lists four, and section cross-references throughout the body
do not resolve against the section numbers actually used.
